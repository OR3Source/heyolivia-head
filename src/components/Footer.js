  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-top">
        ...
        <p>stay updated with the latest news and updates on olivia <span>+</span> livies!</p>
      ...
      <p>
        <span className="copyright">©</span> 2024 heyolivia <span className="copyright">|</span> we're not affiliated with Olivia Rodrigo
      </p>
    </footer>
  );
};
